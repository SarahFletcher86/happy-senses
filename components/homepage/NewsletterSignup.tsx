...
function NewsletterCard({ children }: { children: ReactNode }) {
  return (
    <div className="mx-auto max-w-[760px] rounded-3xl bg-[var(--cream)] px-6 py-12 md:px-12 md:py-16 shadow-[0_1px_2px_rgba(26,32,36,0.04),0_4px_24px_rgba(26,32,36,0.06)] dark:bg-[#232C36] dark:shadow-[0_4px_28px_rgba(0,0,0,0.32)]">
      {children}
    </div>
  );
}
...
export function NewsletterSignup() {
  ...
  if (submitted) {
    return (
      <section id="newsletter" className="bg-[var(--mint)] px-4 py-20 md:py-28 dark:bg-[#141A20]">
        <NewsletterCard>
